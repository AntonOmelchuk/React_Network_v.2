...
const DialogsUsers: React.FC<PropsType> = React.memo(
  ({ dialogs, getMessages, currentId }) => {
      ...
      <div key={d.id}>
        ...
        >
          <div className={style.userHeader}>
            ...
            <div className={style.userActivityDate}>
              {formatDistanceToNow(new Date(d.lastUserActivityDate), {
                addSuffix: true,
              })}
            </div>
          </div>
